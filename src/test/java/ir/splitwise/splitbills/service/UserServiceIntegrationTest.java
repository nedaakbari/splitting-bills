...
public class UserServiceIntegrationTest {
    ...
    @Test
    void findUserById_whenSomeIdNotExist_theFailed() throws UserNotFoundException {
        List<Long> userIds = List.of(appUser1.getId(), appUser2.getId(), 100L);
        List<AppUser> foundFromBd = userService.findAllUserById(userIds);
        Assertions.assertNotEquals(userIds.size(),foundFromBd.size());
        Assertions.assertThrows(UserNotFoundException.class,
                () -> userService.findUserById(100));
    }
}
